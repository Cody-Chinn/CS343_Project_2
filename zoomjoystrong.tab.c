...
{
       0,    36,    36,    59,    78,    94,   117,   138,   139,   140,
     141,   142,   143,   146
};
#endif
...
static const char *const yytname[] =
{
  ...
  "CIRCLE", "RECTANGLE", "SET_COLOR", "INT", "FLOAT", "$accept", "line",
  "circle", "point", "rectangle", "set_color", "drawing", "end", YY_NULLPTR
};
#endif
...
{
       1,    15,     2,     3,     4,     5,     6,    20,    21,    22,
      23,    24,    14,    16,    17,    18,    19,    25,    31,    26,
...
{
       3,    10,     5,     6,     7,     8,     9,     7,     8,     9,
      10,    11,     4,    10,    10,    10,    10,     0,     4,    10,
...
#line 79 "zoomjoystrong.y" /* yacc.c:1646  */
    {
			printf("%s %d %d", (yyvsp[-3].str), (yyvsp[-2].i), (yyvsp[-1].i));
...
#line 1291 "zoomjoystrong.tab.c" /* yacc.c:1646  */
    break;
...
#line 1316 "zoomjoystrong.tab.c" /* yacc.c:1646  */
    break;

  case 6:
#line 118 "zoomjoystrong.y" /* yacc.c:1646  */
    {
			printf("%s %d %d %d\n", (yyvsp[-4].str), (yyvsp[-3].i), (yyvsp[-2].i), (yyvsp[-1].i));

			// Error Checking for all four variables
			//(x and y coordinates for each corresponding point)
			if((yyvsp[-3].i) < 0 || (yyvsp[-3].i) > 255)
				yyerror("Please provide a valid R value under 255");

			if((yyvsp[-2].i) < 0 || (yyvsp[-2].i) > 255)
...
#line 1338 "zoomjoystrong.tab.c" /* yacc.c:1646  */
  ...
  case 13:
#line 147 "zoomjoystrong.y" /* yacc.c:1646  */
    {
		printf("%s\n", (yyvsp[-1].str));
		finish();
	}
#line 1347 "zoomjoystrong.tab.c" /* yacc.c:1646  */
    break;


#line 1351 "zoomjoystrong.tab.c" /* yacc.c:1646  */
      default: break;
    }
...
#line 152 "zoomjoystrong.y" /* yacc.c:1906  */
